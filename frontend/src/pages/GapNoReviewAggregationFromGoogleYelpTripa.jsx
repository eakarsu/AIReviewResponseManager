...
export default function GapNoReviewAggregationFromGoogleYelpTripa() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-review-aggregation-from-google-yelp-tripa', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', fontFamily: 'system-ui, sans-serif' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 4 }}>No review aggregation from Google, Yelp, TripAdvisor, Amazon (no APIs)</h1>
      <p style={{ color: '#666', marginBottom: 16 }}>AIReviewResponseManager - Gap feature</p>
