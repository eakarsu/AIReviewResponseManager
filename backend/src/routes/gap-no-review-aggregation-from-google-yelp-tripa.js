...
const FEATURE_SLUG = 'no-review-aggregation-from-google-yelp-tripa';
const FEATURE_TITLE = 'No review aggregation from Google, Yelp, TripAdvisor, Amazon (no APIs)';
const PROJECT = 'AIReviewResponseManager';
